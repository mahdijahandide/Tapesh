...
public class BluetoothActivity extends AppCompatActivity {
    ...
    public StringBuilder globalData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart_button=(FButton)findViewById(R.id.show_chart);
        ...
        mHandler = new Handler(){
            ...
            public void handleMessage(Message msg){
                if(msg.what == MESSAGE_READ){
                    ...
                    globalData.insert(0,readMessage);
                }
        ...
        if (mBTArrayAdapter == null) {
          ...
          chart_button.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  Intent myIntent = new Intent(BluetoothActivity.this, ChartActivity.class);
                  ActivityOptions options =
                          ActivityOptions.makeCustomAnimation(BluetoothActivity.this, R.anim.fadein, R.anim.fadeout);
        ...
        ChartActivity.bluetoothActivity = this;
